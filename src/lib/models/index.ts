...
export const MODEL_REGISTRY: Record<string, ModelConfig> = {
  ...
  'nano-banana': {
    ...
    dimensionType: 'aspect_ratio',
    tags: ['fast', 'google', 'text-rendering', 'editing'],
    estimatedTime: '~3s',
    isActive: true,
    isNew: true,
  },
  ...
  'flux-dev-edit': {
    ...
    credits: 2,
    tier: 'standard',
    description: 'High quality image editing with excellent detail',
    supportedRatios: ['1:1', '16:9', '4:3', '3:4', '9:16'],
    dimensionType: 'aspect_ratio',
    defaultParams: { output_format: 'webp', output_quality: 90 },
    tags: ['editing', 'img2img'],
  ...
  'gpt-image-mini': {
    ...
    credits: 1,
    tier: 'fast',
    description: 'Fast & affordable OpenAI image generation and editing',
    supportedRatios: ['1:1', '16:9', '9:16', '4:3', '3:4', '3:2', '2:3', '21:9'],
    dimensionType: 'width_height',
    defaultParams: { quality: 'auto' },
    tags: ['fast', 'openai', 'editing'],
    estimatedTime: '~3s',
    isActive: true,
    isNew: true,
  },
  ...
  'gpt-image': {
    ...
    credits: 2,
    tier: 'standard',
    description: 'Balanced OpenAI image generation and editing',
    supportedRatios: ['1:1', '16:9', '9:16', '4:3', '3:4', '3:2', '2:3', '21:9'],
    dimensionType: 'width_height',
    defaultParams: { quality: 'auto' },
    tags: ['balanced', 'openai', 'editing'],
    estimatedTime: '~5s',
    isActive: true,
    isNew: true,
  },
  ...
  'gpt-image-hd': {
    ...
    credits: 3,
    tier: 'premium',
    description: 'State-of-the-art OpenAI image generation and editing',
    supportedRatios: ['1:1', '16:9', '9:16', '4:3', '3:4', '3:2', '2:3', '21:9'],
    dimensionType: 'width_height',
    defaultParams: { quality: 'high' },
    tags: ['premium', 'openai', 'best-quality', 'editing'],
    estimatedTime: '~8s',
    isActive: true,
    isNew: true,
  },
  ...
  'nano-banana-pro': {
    ...
    tags: ['google', 'premium', 'text-rendering', '4k', 'thinking', 'editing'],
    estimatedTime: '~10s',
    isActive: true,
    isNew: true,
  },
