...
export const MODEL_REGISTRY: Record<string, ModelConfig> = {
  ...
  'nano-banana': {
    ...
    name: 'Nano Banana',
    provider: 'google',
    providerModelId: 'gemini-2.0-flash-preview-image-generation',
    credits: 1,
    tier: 'fast',
    description: 'Google Gemini 2.0 Flash - ultra-fast image generation',
  ...
  'flux-dev': {
    ...
    credits: 2,
    tier: 'standard',
    description: 'High quality, excellent detail',
    supportedRatios: ['1:1', '16:9', '4:3', '3:4', '9:16'],
    dimensionType: 'aspect_ratio',
  ...
  'flux-pro': {
    ...
    credits: 3,
    tier: 'premium',
    description: 'Faster and improved, excellent quality',
    supportedRatios: ['1:1', '16:9', '4:3', '3:4', '9:16'],
    dimensionType: 'aspect_ratio',
  ...
  'imagen-4': {
    ...
    credits: 3,
    tier: 'premium',
    description: 'Google flagship, superior detail & typography',
    supportedRatios: ['1:1', '16:9', '4:3', '3:4', '9:16'],
    dimensionType: 'aspect_ratio',
    defaultParams: { output_format: 'jpg', safety_filter_level: 'block_only_high' },
    tags: ['google', 'typography', 'detailed'],
    estimatedTime: '~6s',
    isActive: true,
  },
  ...
  'dall-e-3': {
    ...
    credits: 3,
    tier: 'premium',
    description: 'Premium quality, best for complex prompts',
    supportedRatios: ['1:1', '16:9', '9:16'],
    dimensionType: 'width_height',
    tags: ['creative', 'complex-prompts'],
    estimatedTime: '~8s',
    isActive: true,
  },
  ...
  'flux-ultra': {
    ...
    credits: 4,
    tier: 'ultra',
    description: 'Maximum quality FLUX model with enhanced resolution',
    supportedRatios: ['1:1', '16:9', '9:16', '4:3', '3:4', '21:9'],
    dimensionType: 'aspect_ratio',
    defaultParams: { output_format: 'webp', output_quality: 95 },
    tags: ['ultra-quality', 'high-res'],
    estimatedTime: '~10s',
    isActive: true,
    isNew: true,
  },
  ...
  'nano-banana-pro': {
    ...
    credits: 4,
    tier: 'ultra',
    description: 'Google Imagen 3 - premium quality with 4K output and best text rendering',
    supportedRatios: ['1:1', '16:9', '9:16', '4:3', '3:4'],
    dimensionType: 'aspect_ratio',
    tags: ['google', 'premium', 'text-rendering', '4k'],
    estimatedTime: '~8s',
    isActive: true,
    isNew: true,
  },
